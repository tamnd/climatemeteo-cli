...
func TestHostWiring(t *testing.T) {
	...
	if want := "climatemeteo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("climatemeteo", "about")
	if err != nil || got.String() != "climatemeteo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want climatemeteo://page/about", got.String(), err)
	}
}
