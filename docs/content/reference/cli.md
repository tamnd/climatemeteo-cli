...
```
climatemeteo <command> [arguments] [flags]
```

Run `climatemeteo <command> --help` for the full flag list on any command. This
...
per operation you declare in `climatemeteo/domain.go`.
