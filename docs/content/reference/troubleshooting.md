...
Most of these come down to network reality or how climatemeteo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

climatemeteo rate-limits like any public site. climatemeteo already paces
...
Where a surface is gated, climatemeteo reads a cookie or token you supply
...
`climatemeteo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what climatemeteo actually did
